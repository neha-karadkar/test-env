...
class Config:
    ...
    # Model configuration sets for LLM parameter support
    ...
    def get_llm_kwargs(cls):
        """Return dict of LLM kwargs for chat.completions.create()."""
        kwargs = {}
...
def _initialize_config():
    ...
    # All config variables required for agent and observability
    CONFIG_VARIABLES = [
        # General
        "ENVIRONMENT",
        # LLM / Model
